...
urlpatterns = [
    path('catalogs/', feeds.CatalogsFeed(), name='catalogs'),
    ...
    path('books/', feeds.LangFeed(), name='lang_books'),
    path('books/0/', feeds.BooksFeed(), name='nolang_books'),
    ...
    path('authors/', feeds.LangFeed(), name='lang_authors'),
    path('authors/0/', feeds.AuthorsFeed(), name='nolang_authors'),
    ...
    path('series/', feeds.LangFeed(), name='lang_series'),
    path('series/0/', feeds.SeriesFeed(), name='nolang_series'),
    ...
    path('genres/', feeds.GenresFeed(), name='genres'),
    re_path(r'^genres/(?P<section>\d+)/$', feeds.GenresFeed(), name='genres'),

    path('search/', feeds.OpenSearch, name='opensearch'),
    ...
    path('search/books/u/0/', feeds.SearchBooksFeed(), name='bookshelf'),
    ...
    path('thumb/', dl.Cover, name='covertmpl'),

    path('', feeds.MainFeed(), name='main'),
]